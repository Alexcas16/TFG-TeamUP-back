...
public class UsuarioDAOimpl {
	...
	public void guardarUsuario(UsuarioEntity usuario) throws Exception {
		try {
	        ...
	        Throwable cause = e2.getCause(); // TODO - MEJORAR
	...
	public void addGameById(UsuarioEntity newUser, Long gameId) throws TeamUPexception {
		try {
	        ...
	        // COMPROBAR SI YA TIENE EL JUEGO
	        if (!listaJuegos.contains(juego)) {
	        	...
	        	throw new TeamUPexception("El usuario ya tiene este juego en su lista", CodigoError.JUEGO_YA_EXISTE); // code 4
	        }
		} catch (Exception e) {
